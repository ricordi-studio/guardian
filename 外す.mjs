...
const 口の宣言 = {
  ...
  /* ★★★【混入は承知】(27.57、2026-09-05、@codex 04:22)。
  ...
  '--混入は承知': { 個数: 0, mode: null, 使えるmode: ['外す'] },
};
  ...
  if (束も消す) {
    if (判定 !== 'PASS') {
      ...
      if (!束の控え) {
        ...
        console.log('  ★★★【壊す前に 言います】── ★この口は【安全】とは 名乗りません。');
        console.log('    ★install の【前】から 束の中に 在った あなたの物は、'
          + '★★控えに【塊の物として】取り込まれています ── ★★★一緒に 消えます。');
        console.log('    ★見分ける手は まだ 在りません(★★配る側が 一覧と 指紋を 添えるまで)。');
        if (!process.argv.includes('--混入は承知')) {
          console.log('  ★★★束は 消しませんでした ── ★上を 読んで、それでも 消すなら'
            + ' `--外す --束も --混入は承知` を 打ってください。'
